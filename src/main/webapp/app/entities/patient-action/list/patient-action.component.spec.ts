...
describe('PatientAction Management Component', () => {
  let comp: PatientActionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PatientActionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.patientActions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
