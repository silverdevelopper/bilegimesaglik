...
describe('PatientTask Management Component', () => {
  let comp: PatientTaskComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PatientTaskComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.patientTasks?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
