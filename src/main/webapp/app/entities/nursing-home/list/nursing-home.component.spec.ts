...
describe('NursingHome Management Component', () => {
  let comp: NursingHomeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(NursingHomeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.nursingHomes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
